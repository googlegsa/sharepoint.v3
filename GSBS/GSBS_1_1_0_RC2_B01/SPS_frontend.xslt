...
<!--amit has commented this -->
  ...
  <xsl:if test="$show_sps_icons != '0'">
    <xsl:choose>
      <xsl:when test="MT[@N='google:objecttype']/@V='Wiki Page'"><img src="/_layouts/images/wiki.png" height='16' width='43' alt="Wiki Page"></img></xsl:when> 
    </xsl:choose>
...
<!-- *** SPSMod:  Result Title (including PDF tag and hyperlink) *** -->
  ...
  <xsl:if test="$show_res_title != '0'">
    ...
    <xsl:choose>
      ...
      <xsl:when test="@MIME='text/plain'"><img src="/_layouts/images/iclog.gif" alt="Text Doc"></img></xsl:when>
      <xsl:when test="@MIME='application/rtf'"><img src="/_layouts/images/icrtf.gif" alt="Richtext Doc"></img></xsl:when>
      <!--
      ...
      <xsl:when test="@MIME='application/vnd.ms-powerpoint'"><img src="/_layouts/images/icpot.gif" alt="MS Powerpoint"></img></xsl:when>
      <xsl:when test="@MIME='application/vnd.ms-excel'"><img src="/_layouts/images/icxls.gif" alt="MS Excel"></img></xsl:when>
      <xsl:when test="@MIME='application/msword'"><img src="/_layouts/images/icdoc.gif" alt="MS Word"></img></xsl:when>
