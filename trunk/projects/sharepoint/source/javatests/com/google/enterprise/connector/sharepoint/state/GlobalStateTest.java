...
public class GlobalStateTest extends TestCase {
	...
	public final void testBasic() throws SharepointException {
	    ...
	    docTree.add(doc3);
	    final SPDocument doc4 = new SPDocument("id4", "url4", new GregorianCalendar(2007, 1, 4), SPConstants.NO_AUTHOR, SPConstants.NO_OBJTYPE, SPConstants.PARENT_WEB_TITLE, SPConstants.CONTENT_FEED,SPConstants.METADATA_URL_FEED);
	    docTree.add(doc4);
		...
		this.state.saveState();//save the state to disk.. forms TMP_DIR\Sharepoint_state.xml file
		...
		this.state.setBFullReCrawl(true);//Set this true when one crawling cycle is over
		...
		this.state.endRecrawl(this.sharepointClientContext);//list2 will be removed from global state
