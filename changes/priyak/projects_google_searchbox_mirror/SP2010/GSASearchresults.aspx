...
<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" Inherits="Microsoft.Office.Server.Search.Internal.UI.OssSearchResults"  EnableSessionState="True"  EnableViewState="true" EnableViewStateMac="false"     %> 
...
<asp:content id="Content5" contentplaceholderid="PlaceHolderTitleBreadcrumb" runat="server">
    ...
    <table width="100%" cellpadding="2" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td colspan="8">
            <asp:HiddenField id="hfPublicSearch" runat="server" ></asp:HiddenField>
            <asp:HiddenField id="hfScope" runat="server" ></asp:HiddenField>
            <asp:HiddenField id="hfSearchQuery" runat="server" ></asp:HiddenField>
            <asp:HiddenField id="hfScopeText" runat="server" ></asp:HiddenField>
