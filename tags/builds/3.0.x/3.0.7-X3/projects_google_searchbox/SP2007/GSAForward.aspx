...
<%
  ...
  else // This is Original GSAForward.aspx which will be used to serve non search requests
  {
      ...
      {
          if (response.Headers.Keys[i].ToString() == "Transfer-Encoding")
          {
              gsaHelper.log(String.Format("Skipping {0}={1}", response.Headers.Keys[i], response.Headers[i]), LOG_LEVEL.INFO);
              continue;
          }
