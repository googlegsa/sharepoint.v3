 ...
 * This is the primary class which represents a new connector instance. 
 * Every time a new connector instance is created, an object of this class is created. 
...
public class SharepointConnector implements Connector {
    ...
    /**
     * All the arguemenmts required to create an instance of this class are defined in the file connector_Instance.xml 
     * The arguement supplied here must match those specified under connector_Instance.xml and vice-versa 
     */
    public SharepointConnector(final String sharepointUrl, final String domain, final String username, final String password, 
    		final String googleConnectorWorkDir,final String includedURls,final String excludedURls,
    		final String mySiteBaseURL,final String aliasMapString, final String feedType) throws SharepointException { 
