...
public class DateUtilTest extends TestCase {
  ...
  public final void testDateConversion() throws Throwable {
    System.out
        .println("Testing if date conversion from ISO 8601 to Calendar and back preserves the original value");
    Calendar calendarDate = DateUtil.iso8601ToCalendar(SAMPLE_ISO_8601_DATE_STRING);
    String retrievedDateString =
        DateUtil.calendarToIso8601(calendarDate, DateUtil.Iso8601DateAccuracy.SECS);
    assertEquals(
        "SHOW STOPPER Error:  The date value is not being preserved while converting from and to ISO8601. This will break your change detection logic for WSS 2.0 and SPS 2003",
        SAMPLE_ISO_8601_DATE_STRING, retrievedDateString);
