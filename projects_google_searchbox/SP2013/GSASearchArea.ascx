...
<%   
    ...
    */
    ...
    goLink.Attributes.Add("onClick", String.Format("javascript:SendSearchRequesttoGSA({0});return false;", strEncodedUrl));
...
<asp:CheckBox ID="chkPublicSearch" runat="server"  Width="120px" OnCheckedChanged="checkPublicSearch"   AutoPostBack="true" TextAlign="Right"  style="vertical-align:bottom;"  ToolTip="Check this to search public content" Text="Public Search"   />
</div>
