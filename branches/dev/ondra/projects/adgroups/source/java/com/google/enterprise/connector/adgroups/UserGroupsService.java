...
import com.google.enterprise.connector.adgroups.LdapConstants.ServerType;
 ...
 * {@link AdGroupsAuthenticationManager} and also it talks to
...
public class UserGroupsService implements LdapService {
	...
	private ConnectorContext sharepointClientContext;
	...
	public UserGroupsService(LdapConnectionSettings ldapConnectionSettings,
			ConnectorContext inSharepointClientContext) {
	...
	public UserGroupsService(ConnectorContext inSharepointClientContext) {
	 ...
	 * 
	 * @see com.google.enterprise.connector.sharepoint.ldap.LdapService#
	 * getAllSearchUserGroups (com.google.enterprise.connector.adgroups.
	 * ConnectorContext , java.lang.String)
	 */
	public Set<String> getAllGroupsForSearchUser(
			ConnectorContext sharepointClientContext, AuthenticationIdentity identity)
