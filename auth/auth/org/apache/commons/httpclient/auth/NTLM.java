 ...
 *
 * <p>Please note that an implementation of JCE (java cryptographic extension ..for key generation , encryption etc.) must be correctly installed and configured when
...
final class NTLM {
    ...
    public String getType1Message(String host, String domain) {
        LOG.trace("enter getType1Message");
        LOG.trace("host = " + host + ", domain=" + domain);
    ...
    public byte[] parseType2Message(String message) {
        ...
        System.out.println(String.valueOf(Base64.encodeBase64(nonce)));
        return nonce;
    }
    ...
    throws AuthenticationException {
        ...
        LOG.trace("enter getType3Message");
        LOG.trace("host = " + host + ", user=" + user + ", pwd=" + password +", domain=" + domain);
        int ntRespLen = 0;
        int lmRespLen = 24;
        domain = domain.toUpperCase();
        host = host.toUpperCase();
