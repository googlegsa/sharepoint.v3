...
public class BasicScheme extends RFC2617Scheme {
    ...
    public String authenticate(Credentials credentials, HttpMethod method) throws AuthenticationException {
        ...
        try {
            usernamepassword = (UsernamePasswordCredentials) credentials;
            if (credentials instanceof NTCredentials)//meaning it has domain name
            {
              usernamepassword.setUserName(((NTCredentials)credentials).getDomain() + "\\" + ((NTCredentials)credentials).getUserName());
            }
        } catch (ClassCastException e) {
            throw new InvalidCredentialsException(
                    "Credentials cannot be used for basic authentication: " 
