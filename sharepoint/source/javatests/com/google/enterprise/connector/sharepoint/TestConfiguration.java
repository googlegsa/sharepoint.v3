...
public class TestConfiguration {
	public static final String Site1_List_Item_MSG_File_URL = null;
	...
	public static QueryProvider getUserDataStoreQueryProvider()
		...
		queryProvider.setUdsIndexName("Connector_Names");
	...
	public static LdapConnectionSettings getLdapConnetionSettings() {
		...
		LdapConnectionSettings settings = new LdapConnectionSettings(
				Method.STANDARD, "10.88.34.14", 3268, "DC=connect,DC=com",
				AuthType.SIMPLE, "user2", "Admin1234", "connect.com",
				"(&(objectClass=user)(objectClass=person)(userprincipalname=%s))");

		// LdapConnectionSettings settings = new LdapConnectionSettings(
		// Method.STANDARD, "10.88.33.206", 389, "DC=newgdc-psl,DC=net",
		// AuthType.SIMPLE, "aclark", "Admin1234", "newgdc-psl.net",
