...
public interface LdapService {
	...
	/**
	 * Returns search base information for the search user.
	 * 
	 * @param userName the search user name.
	 * @return search base for the user.
	 */
	String getUserSearBase(String userName);

	/**
	 * Returns domain name from dn.
	 * 
	 * @param dn
	 * @return domain name.
	 */
	String getDomainNameFromDN(String dn);
}
