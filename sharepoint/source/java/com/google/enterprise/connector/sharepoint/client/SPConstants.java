...
public class SPConstants {
	...
	// The string to be stripped off from the atrribute's name as web service return so.
	...
	// Constant used by ListsWS for precessing the list item data returned by the Web Service.
	...
	public static final SimpleDateFormat ISO8601_DATE_FORMAT_SECS =new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
	public static final SimpleDateFormat ISO8601_DATE_FORMAT_MILLIS =new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
	...
	// Constants used by SiteDataWS while processing the list data as returned by the Web Service.
	...
	// Other Misc. characters used mostly by SharePointClientUtils and during processing the data returned by WS.
