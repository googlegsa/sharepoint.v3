...
public class SPConstants {
	...
	public static final String LDAP_FILTER_DEFAULT_VALUE = "(&(objectClass=user)(objectClass=person)(sAMAccountName=%s))";
	public static final String FILTER = "userSearchFilter";
	public static final String PECENTILE_S = "%s";
