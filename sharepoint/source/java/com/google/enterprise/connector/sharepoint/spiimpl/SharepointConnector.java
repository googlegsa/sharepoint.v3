...
public class SharepointConnector implements Connector,
	...
	public void init() throws SharepointException {
		...
		sharepointClientContext.setMultiDomainSupported(this.multiDomainSupported);
		if (pushAcls) {
	...
	public boolean getMultiDomainSupported() {
		return multiDomainSupported;
	}

	public void setMultiDomainSupported(boolean multiDomainSupport) {
		this.multiDomainSupported = multiDomainSupport;
	}
}
